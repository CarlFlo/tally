...
//go:embed migration_009.sql
var migration009 string

//go:embed migration_010.sql
var migration010 string

//go:embed migration_011.sql
var migration011 string

//go:embed migration_012.sql
var migration012 string

//go:embed migration_013.sql
...
func (s *Store) migrate(ctx context.Context, dir string, existing bool) error {
	...
	if version < Version {
		...
		for next := version + 1; next <= Version && e == nil; next++ {
			...
			case 9:
				_, e = tx.ExecContext(ctx, migration009)
			case 10:
				_, e = tx.ExecContext(ctx, migration010)
			case 11:
				_, e = tx.ExecContext(ctx, migration011)
			case 12:
				_, e = tx.ExecContext(ctx, migration012)
			case 13:
			...
			case 16:
				_, e = tx.ExecContext(ctx, migration016)
			default:
