...
func TestJobDedupCancellationAndDeadline(t *testing.T) {
	...
	defer p.Close()
	_, e = db.Exec("INSERT INTO shows(id,name) VALUES('show','Example'); INSERT INTO external_ids VALUES('tvmaze','show','7','show'); INSERT INTO profile_shows(profile_id,show_id,added_at) VALUES('user0','show',1)")
	if e != nil {
		t.Fatal(e)
	}
...
func TestJobDeadlineCountsAsFailure(t *testing.T) {
	...
	defer p.Close()
	if _, e = db.Exec("INSERT INTO shows(id,name) VALUES('show','Example'); INSERT INTO external_ids VALUES('tvmaze','show','7','show'); INSERT INTO profile_shows(profile_id,show_id,added_at) VALUES('user0','show',1)"); e != nil {
		t.Fatal(e)
	}
