...
DROP TABLE torrent_automation_feedback; DROP TABLE torrent_bad_hashes; DROP TABLE torrent_show_policy; DROP TABLE torrent_automation_runs; DROP TABLE torrent_show_media_profile; ALTER TABLE shows DROP COLUMN show_type;
