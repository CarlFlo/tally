...
ALTER TABLE jobs DROP COLUMN revision; DROP TABLE download_client_settings; CREATE TABLE counters (key TEXT PRIMARY KEY, value INTEGER NOT NULL); INSERT INTO counters VALUES ('profile',1); PRAGMA user_version=1;
